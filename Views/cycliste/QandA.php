...
<main class="container mx-auto px-4 py-8 max-w-4xl">
    ...
    <div class="bg-white rounded-lg shadow-sm mb-6">
        ...
        <div class="p-4 border-b">
            <div class="flex items-start space-x-3">
                ...
                <div class="flex-1">
                    ...
                    <p class="mt-2">Comment gérer l'alimentation pendant une étape de montagne ? J'ai du mal à trouver
                        le bon équilibre entre l'énergie nécessaire et le poids.</p>
                </div>
            </div>
        </div>
        ...
        <div class="px-4 py-2 border-b flex items-center space-x-4 text-sm text-gray-600">
            <div class="flex items-center space-x-2">
                <button class="hover:bg-gray-100 p-1 rounded flex items-center justify-center">
        ...
        <div class="p-4 space-y-4">
            ...
            <div class="pl-8 border-l-2 border-gray-200">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center space-x-2">
                            <h4 class="font-bold">Tadej Pogača</h4>
                            <span class="text-sm text-gray-500">• 1h</span>
                        </div>
                        <p class="mt-1 text-sm">Je recommande de prendre des barres énergétiques toutes les 45 minutes
                            et de bien s'hydrater. Pour les cols, privilégiez les glucides complexes avant
                            l'ascension.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="p-4 border-b">
            <div class="flex items-start space-x-3">
                ...
                <div class="flex-1">
                    ...
                    <p class="mt-2">Quelle est la meilleure façon de récupérer après une étape difficile ? Je participe
                        à une course par étapes la semaine prochaine.</p>
                </div>
            </div>
        </div>
